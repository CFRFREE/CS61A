...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    return tree(
        label(t), [replace_loki_at_leaf(y, lokis_replacement) for y in branches(t)]
    )
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    tep = make_city("Free", lat, lon)
    if distance(city_a, tep) < distance(city_b, tep):
